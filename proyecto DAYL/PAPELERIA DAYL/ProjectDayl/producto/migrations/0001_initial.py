    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, help_text='Imagen del producto', null=True, upload_to='imagen/productos')),
                ('porcentaje_iva', models.DecimalField(decimal_places=2, help_text='Porcentaje del iva ej = 16 - 19 ...', max_digits=3)),
                ('precio', models.DecimalField(decimal_places=3, help_text='Valor del producto antes de iva', max_digits=10)),
